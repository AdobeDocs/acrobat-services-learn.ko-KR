...
[Microsoft Services](https://flow.microsoft.com) 커넥터를 사용하여 [Adobe PDF Power Automate](https://us.flow.microsoft.com/en-us/connectors/shared_adobepdftools/adobe-pdf-services/)에서 첫 번째 흐름을 만드는 방법을 알아봅니다.
...
1. **[!UICONTROL 템플릿 파일 내용]** 필드에서 **[!UICONTROL 동적 내용]** 패널을 사용하여 **[!UICONTROL 파일 내용 가져오기]** 단계에서 *파일 내용* 값을 삽입합니다.
...
1. **[!UICONTROL 파일 내용 -1]** 필드에서 **[!UICONTROL 동적 내용]** 패널을 사용하여 *Word를 PDF으로 변환* 단계에서 **[!UICONTROL PDF 파일 내용]** 값을 삽입합니다.
1. 다음 문서를 추가하려면 **+ [!UICONTROL 새 항목 추가]**&#x200B;를 선택합니다.
1. **[!UICONTROL 파일 콘텐츠 - 2]** 필드에서 **[!UICONTROL 동적 콘텐츠]** 패널을 사용하여 **[!UICONTROL Word 템플릿에서 문서 생성]** 단계에서 *출력 파일 콘텐츠* 값을 삽입합니다.
...
1. **[!UICONTROL 파일 내용]** 필드에서 **[!UICONTROL 동적 내용]** 패널을 사용하여 *PDF 병합* 단계에서 **[!UICONTROL PDF 파일 내용]** 값을 삽입합니다.
...
1. Power Automate에서 플로우를 편집하는 동안 **PDF 병합** 작업과 **[!UICONTROL 파일 만들기 3]** 작업 사이에 있는 **[!UICONTROL +]**&#x200B;을(를) 선택합니다.
